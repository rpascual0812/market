...
class OrderPageBuyer extends StatefulWidget {
  const OrderPageBuyer({super.key, required this.type, required this.user});

  final String type;
  final Map<String, dynamic> user;

  @override
  State<OrderPageBuyer> createState() => _OrderPageBuyerState();
}

class _OrderPageBuyerState extends State<OrderPageBuyer> {
  @override
